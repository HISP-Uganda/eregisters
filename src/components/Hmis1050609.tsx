...
export type Hmis1050609Values = Record<string, string>;

export interface Hmis1050609FormProps {
    period?: string;
    orgUnit?: string;
    initialValues?: Hmis1050609Values;
    readOnly?: boolean;
...
const InnerHmis1050609Form: React.FC<Hmis1050609FormProps> = ({
    period,
    orgUnit,
    initialValues,
    readOnly = false,
    ...
    const [values, setValues] = React.useState<Hmis1050609Values>(
        initialValues ?? {},
    );
    ...
    const handleSave = async () => {
        ...
        if (onSave) {
            ...
            console.log("HMIS 105:06-09 dataValueSet payload:", payload);
            message.success(
...
const Hmis1050609Form: React.FC<Hmis1050609FormProps> = (props) => (
    <ConfigProvider
        theme={{
            token: {
                colorPrimary: TEAL,
