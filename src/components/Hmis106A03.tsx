...
export type Hmis106A03Values = Record<string, string>;

export interface Hmis106A03FormProps {
    period?: string;
    orgUnit?: string;
    initialValues?: Hmis106A03Values;
    readOnly?: boolean;
...
const InnerHmis106A03Form: React.FC<Hmis106A03FormProps> = ({
    period,
    orgUnit,
    initialValues,
    readOnly = false,
    ...
    const [values, setValues] = React.useState<Hmis106A03Values>(
        initialValues ?? {},
    );
    ...
    const handleSave = async () => {
        ...
        if (onSave) {
            ...
            console.log("HMIS 106A:03 dataValueSet payload:", payload);
            message.success(
...
const Hmis106A03Form: React.FC<Hmis106A03FormProps> = (props) => (
    <ConfigProvider
        theme={{
            token: {
                colorPrimary: TEAL,
