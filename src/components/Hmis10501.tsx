...
export type Hmis105Values = Record<string, string>;

export interface Hmis105Section1FormProps {
    period?: string;
    orgUnit?: string;
    initialValues?: Hmis105Values;
    readOnly?: boolean;
...
const InnerHmis105Section1Form: React.FC<Hmis105Section1FormProps> = ({
    period,
    orgUnit,
    initialValues,
    readOnly = false,
    ...
    const [values, setValues] = React.useState<Hmis105Values>(
        initialValues ?? {},
    );
    ...
    const handleSave = async () => {
        ...
        if (onSave) {
            ...
            console.log("HMIS 105:01 dataValueSet payload:", payload);
            message.success(
...
const Hmis105Section1Form: React.FC<Hmis105Section1FormProps> = (props) => (
    <ConfigProvider
        theme={{
            token: {
                colorPrimary: TEAL,
    ...
    >
        <App>
            <InnerHmis105Section1Form {...props} />
        </App>
    </ConfigProvider>
);
