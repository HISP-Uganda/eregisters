...
export type Hmis1050203Values = Record<string, string>;

export interface Hmis1050203FormProps {
    period?: string;
    orgUnit?: string;
    initialValues?: Hmis1050203Values;
    readOnly?: boolean;
...
const InnerHmis1050203Form: React.FC<Hmis1050203FormProps> = ({
    period,
    orgUnit,
    initialValues,
    readOnly = false,
    ...
    const [values, setValues] = React.useState<Hmis1050203Values>(
        initialValues ?? {},
    );
    ...
    const handleSave = async () => {
        ...
        if (onSave) {
            ...
            console.log("HMIS 105:02-03 dataValueSet payload:", payload);
            message.success(
...
const Hmis1050203Form: React.FC<Hmis1050203FormProps> = (props) => (
    <ConfigProvider
        theme={{
            token: {
                colorPrimary: TEAL,
