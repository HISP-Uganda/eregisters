...
export type Hmis10510Values = Record<string, string>;

export interface Hmis10510FormProps {
    period?: string;
    orgUnit?: string;
    initialValues?: Hmis10510Values;
    readOnly?: boolean;
...
const InnerHmis10510Form: React.FC<Hmis10510FormProps> = ({
    period,
    orgUnit,
    initialValues,
    readOnly = false,
    ...
    const [values, setValues] = React.useState<Hmis10510Values>(
        initialValues ?? {},
    );
    ...
    const handleSave = async () => {
        ...
        if (onSave) {
            ...
            console.log("HMIS 105:10 dataValueSet payload:", payload);
            message.success(
...
const Hmis10510Form: React.FC<Hmis10510FormProps> = (props) => (
    <ConfigProvider
        theme={{
            token: {
                colorPrimary: TEAL,
