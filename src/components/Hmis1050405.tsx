...
export type Hmis1050405Values = Record<string, string>;

export interface Hmis1050405FormProps {
    period?: string;
    orgUnit?: string;
    initialValues?: Hmis1050405Values;
    readOnly?: boolean;
...
const InnerHmis1050405Form: React.FC<Hmis1050405FormProps> = ({
    period,
    orgUnit,
    initialValues,
    readOnly = false,
    ...
    const [values, setValues] = React.useState<Hmis1050405Values>(
        initialValues ?? {},
    );
    ...
    const handleSave = async () => {
        ...
        if (onSave) {
            ...
            console.log("HMIS 105:04-05 dataValueSet payload:", payload);
            message.success(
...
const Hmis1050405Form: React.FC<Hmis1050405FormProps> = (props) => (
    <ConfigProvider
        theme={{
            token: {
                colorPrimary: TEAL,
