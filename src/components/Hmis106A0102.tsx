...
export type Hmis106A0102Values = Record<string, string>;

export interface Hmis106A0102FormProps {
    period?: string;
    orgUnit?: string;
    initialValues?: Hmis106A0102Values;
    readOnly?: boolean;
...
const InnerHmis106A0102Form: React.FC<Hmis106A0102FormProps> = ({
    period,
    orgUnit,
    initialValues,
    readOnly = false,
    ...
    const [values, setValues] = React.useState<Hmis106A0102Values>(
        initialValues ?? {},
    );
    ...
    const handleSave = async () => {
        ...
        if (onSave) {
            ...
            console.log("HMIS 106A:01-02 dataValueSet payload:", payload);
            message.success(
...
const Hmis106A0102Form: React.FC<Hmis106A0102FormProps> = (props) => (
    <ConfigProvider
        theme={{
            token: {
                colorPrimary: TEAL,
